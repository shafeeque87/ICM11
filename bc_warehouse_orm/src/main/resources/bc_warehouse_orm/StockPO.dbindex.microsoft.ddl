...
EXEC staging_ddl.create_index('STOCK_IE001', 'STOCK', '(WAREHOUSEID)', 'dummytablespace', 'NONUNIQUE', :recreate_indexes);
EXEC staging_ddl.create_index('STOCK_IE002', 'STOCK', '(PRODUCTID,DOMAINID)', 'dummytablespace', 'NONUNIQUE', :recreate_indexes);
